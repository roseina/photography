				...
				<div class="gallery-grids">
						...
						@foreach($galleryPhotos as $photo)
							<div class="col-md-3 agile-gallery-grid">
								...
								@if($photo->image != "" && file_exists(public_path('uploads/gallery/photos/'.$photo->image)))
									<a href="{{asset('uploads/gallery/photos/'.$photo->image )}}" class="lsb-preview" data-lsb-group="header">
									<img src="{{ asset('uploads/gallery/photos/'.$photo->image) }}">
